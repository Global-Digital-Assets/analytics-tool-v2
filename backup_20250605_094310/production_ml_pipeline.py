...
class ProductionMLPipeline:
    ...
    def run_full_pipeline(self, days_back: int = 180, tag: str = "production"):
    ...
    def run_warm_start_pipeline(self, days_back: int = 180, tag: str = "production"):
...
if __name__ == "__main__":
    ...
    if args.warm:
        pipeline.run_warm_start_pipeline(days_back=args.days, tag=args.tag)
    else:
        pipeline.run_full_pipeline(days_back=args.days, tag=args.tag)
